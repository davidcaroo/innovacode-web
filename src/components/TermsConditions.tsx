                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-text-secondary leading-relaxed mb-3">
                                    Al acceder y utilizar el sitio web <a href="https://innovacode.click" className="text-accent hover:underline">innovacode.click</a> y los servicios de <strong>InnovaCode Solutions</strong>, aceptas cumplir y estar sujeto a los siguientes Términos y Condiciones de uso.
                                </p>
                    ...
                    <div className="bg-bg-card border border-border-primary rounded-2xl p-8 hover:border-accent/30 transition-all duration-300">
                        ...
                        <div className="space-y-4 ml-16 text-text-secondary">
                            ...
                            <ul className="space-y-3">
                                ...
                                <li className="flex items-start gap-2">
                                    <span className="text-accent mt-1">•</span>
                                    <span><strong>"Sitio Web":</strong> El dominio innovacode.click y todas sus páginas relacionadas</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-accent mt-1">•</span>
